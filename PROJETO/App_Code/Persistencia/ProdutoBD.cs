...
namespace PROJETO.Persistencia
{
    ...
    public class ProdutoBD
    {
        ...
        public bool Insert(Produto produto)
        {
            System.Data.IDbConnection objConexao;
            System.Data.IDbCommand objCommand;
            string sql = "INSERT INTO tbl_produto(pro_nome, pro_categoria, pro_precovenda) VALUES (?nome, ?categoria, ?precovenda)";
            objConexao = Mapped.Connection();
        ...
        public Produto Select(int id)
        {
            ...
            while (objDataReader.Read())
            {
                ...
                obj.Categoria = Convert.ToString(objDataReader["pro_categoria"]);
        ...
        public bool Update(Produto produto)
        {
            System.Data.IDbConnection objConexao;
            System.Data.IDbCommand objCommand;
            string sql = "UPDATE tbl_produto SET pro_nome=?nome, pro_categoria=?categoria, pro_precovenda=?precovenda WHERE pro_codigo=?codigo";
            objConexao = Mapped.Connection();
            objCommand = Mapped.Command(sql, objConexao);
            objCommand.Parameters.Add(Mapped.Parameter("?nome", produto.Nome));
            objCommand.Parameters.Add(Mapped.Parameter("?categoria", produto.Categoria));
